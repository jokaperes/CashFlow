...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Expenses must be in the past, not in the future..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Payment type is not valid, must be between 0 and 4.
        /// </summary>
